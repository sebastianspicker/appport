...
use super::{dto, RelutionClient, MAX_JSON_BYTES, MAX_PAGES, PAGE_SIZE};
...
mod transport_tests {
    use super::{
        decode_response_bytes, diagnostic_response_attempt, read_response_at_most, status,
        RequestAttempt, ResponseDiagnostic, MAX_JSON_BYTES,
    };
    use crate::infrastructure::logging;
    use std::{
        io::{Read, Write},

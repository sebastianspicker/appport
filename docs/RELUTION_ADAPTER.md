...
Relution's documented third-party REST personal-token authentication is the
sole sign-in contract. Appport does not use Basic authentication, portal
cookies, or HTML login scraping.
